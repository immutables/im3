...
public abstract class Codec<T> {
	 ...
	 * for the {@code instanceof NullAware}, but also to check if {@link #supportsNull()} is actually
	 * on by
	...
	public interface Factory {
		@Null <T> Codec<T> get(Resolver lookup, TypeToken<T> type);
	}
	...
	public static FieldIndex arbitraryFields() {
		return new FieldIndex() {
			...
			@Override
			public @Null Object get() {return null;}
		};
	}
}
