...
public class Types {
	...
	public static Function<Type, Type> substitution(Map<? extends Type, ? extends Type> map) {
		return t -> {
			var v = map.get(t);
			return v != null ? v : t;
		};
	...
	public static Function<Type, Type> substitution(Type.Parameter parameter, Type replacement) {
		return replacementByRef(parameter, replacement);
	}

	public static Function<Type, Type> substitution(Type.Variable variable, Type replacement) {
